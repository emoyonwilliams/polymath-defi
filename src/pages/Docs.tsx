...
export const Docs = () => {
  ...
  const activeTab = (tabParam === 'about' || tabParam === 'docs' || tabParam === 'security' || tabParam === 'pricing')
    ? tabParam
    : 'about'

  const handleTabChange = (tabId: 'about' | 'docs' | 'security' | 'pricing') => {
          ...
          {activeTab === 'pricing' && (
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="border border-white/[0.04] bg-[#080A10]/40 p-6 rounded-2xl flex flex-col justify-between hover:border-emerald-500/20 transition-all duration-300">
                  <div>
                ...
                <div className="border border-[#10B981]/20 bg-[#0E111A]/60 p-6 rounded-2xl flex flex-col justify-between hover:border-[#10B981]/40 transition-all duration-300 relative overflow-hidden">
